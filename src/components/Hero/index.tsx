            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  We help companies eliminate manual data entry from invoices, including scanned documents. 
                  Our solution extracts critical information at scale, saving time and reducing errors. 
                  Streamline your accounts payable process and focus on what matters most to your business.
                </p>
